...
// Seven skills — five gathering plus cooking and smithing (combat removed).
const SKILL_META: Record<SkillCategory, { label: string; icon: string; color: string }> = {
  ...
  cooking:     { label: "Cooking",     icon: "/assets/foods/pumpkin_soup.png", color: "#fb923c" },
  smithing:    { label: "Smithing",    icon: "/assets/icons/anvil.png",        color: "#a3a3a3" },
};

export const SKILL_ORDER: SkillCategory[] = [
  "farming", "woodcutting", "mining", "fishing", "husbandry", "cooking", "smithing",
];
