      ...
      >
        {secondaryImage ? (
          <div className="w-full flex">
            <img src={getImageSrc(image)} className={classNames("w-4/5 object-contain", imageClassName)} alt="item" />
            <img
          ...
          image && (
            <img
              ...
              className={classNames("h-full w-full object-contain", imageClassName)}
              alt="item"
            />
          )
        )}
