...
export const CopyField: React.FC<Props> = ({ text = "", copyFieldMessage }) => {
  ...
  const copyToClipboard = (): void => {
    ...
    setTimeout(() => { setTooltipMessage(copyFieldMessage); }, 2000);
  };

  return (
    <div className="mb-4">
      <div className="mt-2 bg-brown-200 p-1">
        <div className="flex justify-between p-2 gap-x-2 items-center">
          <span className="text-[0.55rem] sm:text-xs m-auto break-all select-text">{text}</span>
          <span
