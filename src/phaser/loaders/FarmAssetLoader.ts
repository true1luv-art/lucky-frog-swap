...
export const FarmAssetLoader = {
  ...
  _loadTilemap(scene: Phaser.Scene) {
    ...
    scene.load.tilemapTiledJSON('town', 'assets/phaser/maps/town.json')
  ...
  _loadResourceNodes(scene: Phaser.Scene) {
    ...
    scene.load.image('emerald_rock',  'assets/resources/emerald_node.png')
    scene.load.image('diamond_rock',  'assets/resources/diamond_node.png')
    scene.load.image('ignisite_rock', 'assets/resources/ignisite_node.png')
    ...
    scene.load.image('emerald_empty',  'assets/resources/emerald/emerald_empty.png')
    scene.load.image('diamond_empty',  'assets/resources/diamond/diamond_empty.png')
    scene.load.image('ignisite_empty', 'assets/resources/ignisite/ignisite_empty.png')
