 ...
 * Checks the Authorization header first, then falls back to the lfrg_token cookie.
 *
 * Returns null if no valid token is found — callers should return 401 in that case.
 * Mirrors the pattern used in /api/claim and other Phase 1 routes.
 */
