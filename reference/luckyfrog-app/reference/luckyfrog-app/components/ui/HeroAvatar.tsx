...
import { generateAvatarUrl } from "@/shared/game/avatar";
...
interface HeroAvatarProps {
  ...
  emoji?: string;
  /**
   * Optional image override — when set (e.g. the equipped avatar frog's
   * portrait, §2.9) it replaces the generated identicon avatar.
   */
...
export const HeroAvatar: React.FC<HeroAvatarProps> = ({
  ...
  const avatarUrl = imageUrl || generateAvatarUrl(name);
