...
// ── Config ────────────────────────────────────────────────────────────────────
// Frog sprites: idle / walk / mining / axe / doing / casting / caught.
// No dedicated waiting/reeling sheets — those keys alias to idle/casting.
...
const PLAYER_CONFIG = {
  ...
  // No frog waiting sheet — alias to idle so FishingSystem fallback works
  WAITING: { key: 'player_waiting', texture: 'player_idle',    frames: { start: 0, end: 8  }, frameRate: 4,  repeat: -1 },
} as const

const FISHING_CONFIG = {
  CASTING: { key: 'player_casting', texture: 'player_casting', frames: { start: 0, end: 14 }, frameRate: 10, repeat: 0  },
  // No frog reeling sheet — alias to casting so the fishing chain completes
  REELING: { key: 'player_reeling', texture: 'player_casting', frames: { start: 0, end: 14 }, frameRate: 10, repeat: 0  },
